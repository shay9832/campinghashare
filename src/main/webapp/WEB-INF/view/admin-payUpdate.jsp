...
<div id="container">
    ...
    <div id="leftMenu">
        ...
        <!-- 결제 관리 메뉴 -->
        <button class="menu-button active">결제 관리</button>
        <div class="submenu" style="max-height: 200px;">
            <a href="#" style="color: #3f861d; font-weight: bold; border-left: 2px solid #3f861d;">결제 조회</a>
            <a href="#">결제 취소 내역</a>
            <a href="#">결제 통계</a>
        </div>
        ...
        <!-- 등급 관리 메뉴 -->
        <button class="menu-button">등급 관리</button>
        <div class="submenu">
            <a href="#">등급 기준 설정</a>
            <a href="#">등급별 장비 목록</a>
            <a href="#">등급 변경 이력</a>
