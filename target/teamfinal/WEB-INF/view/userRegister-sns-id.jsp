        ...
        <form action="${pageContext.request.contextPath}/register" method="post" id="registerForm">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" id="userName" name="userName" class="form-input" disabled="disabled" style="background-color: var(--color-gray-50);" value="고둘리">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" id="userId" name="userId" class="form-input" disabled="disabled" style="background-color: var(--color-gray-50);" value="000001">
                </div>
            </div>
