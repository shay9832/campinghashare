...
<div class="container">
    <div class="register-container">
        <h2 class="register-title">계정 등록</h2>
        ...
        <form action="${pageContext.request.contextPath}/register" method="post" id="registerForm">
            ...
            <div class="form-group">
                <label for="adminTel" class="form-label">전화번호 <span class="required-field"></span></label>
                <div class="input-group">
                    <input type="text" id="adminTel" name="adminTel" class="form-input" placeholder="업무용 전화번호 입력">
                </div>
            </div>
